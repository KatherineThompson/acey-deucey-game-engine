...
function findAvailableSpaces(gameState, numberOfSpaces) {
    ...
    const activePlayer = isPlayerOne ?
        {
            ...
            possibleStartSpaceIndex: require("./constants").PLAYER_ONE_START_SPACE + numberOfSpaces
        } :
        {
            ...
            possibleStartSpaceIndex: require("./constants").PLAYER_TWO_START_SPACE - numberOfSpaces            
        };
    ...
    return _.remove(availableSpaces, space => space !== undefined);
}
